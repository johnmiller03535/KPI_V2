...
class KpiIndicator(Base):
    ...
    default_weight = Column(Integer, nullable=True)    # Дефолтный вес для is_common показателей
...
class KpiManagementUnit(Base):
    """Справочник управлений для привязки KPI-показателей."""
    __tablename__ = "kpi_management_units"
